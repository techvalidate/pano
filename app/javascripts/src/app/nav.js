import { click as onClick, load as onLoad } from '../global/ui'
// ===================================================
...
onClick('#mobile-nav-trigger', function(e, el) {
...
// open/close the menu when the menu trigger is clicked
onClick('#cur-user-dropdown-trigger', function(e, el) {
...
onLoad(() => $("#subnav.sticky-subnav").stick_in_parent({bottoming: false, offset_top: $('#nav').height()}));
